    ...
    <form action="" method="post">
        <div class="container d-flex align-items-center flex-column">
            ...
            <div class="mb-3 w-50 border-input">
                <input class="input-group w-100" id="name" name="name" type="text"
            ...
            <div class="mb-3 w-75 d-flex justify-content-center">
                <button class="w-50 btn btn-lg btn-login" id="register" name="register" type="button"
                        onclick="checkValidate()">Đăng
                    ký
                </button>
            </div>
