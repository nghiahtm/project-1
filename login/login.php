...
<div id = "main">
    <div class="container d-flex align-items-center flex-column">
        ...
        <div class="mb-3 w-50">
            <input class="input-group input-group-lg" id="email" name="email" type="text" required="required" placeholder="Nhập số điện thoại">
        </div>
        <div class="mb-3 w-50">
            <input class="input-group input-group-lg" id="email" name="password" type="password" required="required" placeholder="Nhập mật khẩu">
        </div>
