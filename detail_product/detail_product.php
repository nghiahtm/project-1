...
<div id = "main">
    <div class="container px-0" id="category">
        <h3>Test 123123123 </h3>
        <div class="row mt-1">
            <div class="col-5" id="features">
                <div class="bg-detail-product d-flex justify-content-center">
            ...
            <div class="col-7">
                <div class="flex-column" id="price">
                    <h4>16.000.000đ</h4>
                    <div class="row row-cols-3 g-3 text-center m-4">
                        <div class="col"><button class="">12312312312</button></div>
                        <div class="col"><button class="">12312312312</button></div>
                        <div class="col"><button class="">12312312312</button></div>
                        <div class="col"><button class="">12312312312</button></div>
                        <div class="col"><button class="">12312312312</button></div>
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1 d-flex align-items-center justify-content-center bg-buy-now">Mua Ngay</div>
                        <div class="bg-buy-later">
                            <img src="https://cdn2.cellphones.com.vn/50x,webp,q70/media/wysiwyg/add-to-cart.png" width="50" alt="cart-icon"></div>
                    </div>
                </div>
            </div>
        </div>
